package com.hhgs.tcw.CityList.citylist;
...
import com.hhgs.tcw.CityList.adapter.HotCityGridAdapter;
import com.hhgs.tcw.CityList.helper.ContactsHelper;
...
public class CityList extends Activity {
    ...
    String[] hotcity = new String[]{"北京", "上海", "广州", "深圳", "兰州", "南京", "天津", "武汉", "重庆"};
    ...
    class CityListOnItemClick implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int pos,
            ...
            if(cityModel!=null) {
                ...
                SP.put("user_city",cityModel.getCityName());
                setResult(2,intent);
                finish();
            }
        }
